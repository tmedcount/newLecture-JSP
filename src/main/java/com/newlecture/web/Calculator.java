...
//		
//		if(request.getMethod().equals("GET")) { //대문자로 받아야 한다
//			System.out.println("GET 요청이 왔습니다.");
//		} else if(request.getMethod().equals("POST")) { //대문자로 받아야 한다
...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse reponse) throws ServletException, IOException {
		Cookie[] cookies = request.getCookies(); // WebBrowser�� path ���� ����
		...
		expCookie.setPath("/calculator"); //쿠기 한정
